...
mark.calcBMI(); // Remember that this is to call the return this.bmi because return will not call itself, something has to call it 
john.calcBMI();
console.log(mark.bmi, john.bmi);

// To call who has the bigger BMI 
